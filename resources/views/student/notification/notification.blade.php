                ...
                <div class="card">
                       <ul class="nav nav-pills flex-column">
                            <li class="nav-item active">
                                <a href="{{route('student.student-notification')}}" class="nav-link">
...
$('.notification_delete').click(function(e){
    ...
    jQuery.ajax({
    type: 'post',
    url: "{{route('student.notification_delete')}}",
    headers: {
    ...
    //     var notificationId = $('.student_notification').attr('data-id');
    //     $.ajax({
    //         type: "POST",
    //         url: "{{route('student.single-notification')}}",
    //         headers: {
    //             'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
    //         },
    //         data: {
    ...
    //     $(".student_notification").on("click", function() {
