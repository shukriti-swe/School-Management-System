...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="row">
      ...
      <div class="col-md-3">
        <a href="{{route('backend.trainer-notificationbox')}}" class="btn btn-primary btn-block mb-3">Back to Inbox</a>
      ...
      <div class="col-md-9">
        ...
        <form action="{{ route('backend.trainer-notification-send') }}" method="POST">
          @csrf
          <div class="card card-primary card-outline">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input id="notificationtitle" name="title" class="form-control">
              </div>
              <div class="form-group">
