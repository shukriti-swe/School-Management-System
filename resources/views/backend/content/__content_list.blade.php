            ...
            <div class="col-md-6">
                <div class="group-filter">
                  ...
                  <select id="group" class="form-control">
                    ...
                    <option value="{{$content['get_age_group']['age']}}">{{$content['get_age_group']['age']}}</option>
                    @endforeach
                  </select>
                </div>
            </div>
            <div class="col-md-6">
              <div class="stream-filter">
                ...
                <select id="stream" class="form-control">
                  <option value="">Show All</option>
                  @foreach($contents as $content)
                  <option value="{{$content['get_stream']['title']}}">{{$content['get_stream']['title']}}</option>
                  @endforeach
                </select>
              </div>
            </div>
